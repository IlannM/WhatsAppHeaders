...
@protocol WADiskUsageSearchChatsViewControllerDelegate;

@interface WADiskUsageSearchChatsViewController : WATableViewController <WASearchControllerDelegate>
{
    NSArray *_chatRows;
    NSArray *_searchResults;
    id <WADiskUsageSearchChatsViewControllerDelegate> _delegate;
}

- (void).cxx_destruct;
- (void)cancelAction:(id)arg1;
@property(nonatomic) id <WADiskUsageSearchChatsViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (id)initWithChatRows:(id)arg1 databaseUsageManager:(id)arg2;
