...
@interface WAStellaCallStateNotifier : NSObject <WAStellaIntentHandling>
{
...
- (void)handleAssistantCallStateNotification:(id)arg1;
- (void)handleCallActiveNotification:(id)arg1;
- (void)handleCallEndedNotification:(id)arg1;
- (void)handleCallStartedNotification:(id)arg1;
- (id)initWithContext:(id)arg1 allowList:(id)arg2 encryption:(id)arg3;
- (_Bool)process:(id)arg1 error:(out id *)arg2;
- (void)registerNotificationHandlers;
- (void)sendCallStateNotificationWithInfo:(id)arg1 state:(long long)arg2;
