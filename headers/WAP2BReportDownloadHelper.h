...
#import "WAP2BReportMetadata-Protocol.h"
...
@interface WAP2BReportDownloadHelper : NSObject <WAMMSMediaDownloadOperationDelegate, WBMMSDownloadOperationDelegate, WAP2BReportMetadata>
{
