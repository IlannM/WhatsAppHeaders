...
@class CXAnswerCallAction, NSArray, NSString, NSUUID, WAGroupJID, WAUserJID;
...
- (id)description;
@property(copy, nonatomic) WAGroupJID *groupJID; // @synthesize groupJID=_groupJID;
- (id)initWithCallUUID:(id)arg1 callID:(id)arg2 peerJIDs:(id)arg3 groupJID:(id)arg4 callType:(long long)arg5 useCallKit:(_Bool)arg6;
@property(copy, nonatomic) WAUserJID *initialPeerJID; // @synthesize initialPeerJID=_initialPeerJID;
@property(nonatomic) _Bool mutedBeforeConnected; // @synthesize mutedBeforeConnected=_mutedBeforeConnected;
