...
#import "WASavedContentSearchResultsTableViewControllerConfigurationDelegate-Protocol.h"
#import "WASearchResultsControllerDelegate-Protocol.h"

@class NSCalendar, NSDateFormatter, NSFetchedResultsController, NSIndexPath, NSString, UIBarButtonItem, UILabel, UISearchController, WAChatJID, WASavedContentSearchResultsTableViewController, WASearchResultsController;

@interface WASavedContentListViewController : WASavedContentBrowserChildTableViewController <UISearchControllerDelegate, UISearchResultsUpdating, WASearchResultsControllerDelegate, WASavedContentSearchResultsTableViewControllerConfigurationDelegate, NSFetchedResultsControllerDelegate, UIViewControllerPreviewingDelegate>
{
    NSString *_chatName;
    ...
    WASavedContentSearchResultsTableViewController *_searchResultsTableViewController;
