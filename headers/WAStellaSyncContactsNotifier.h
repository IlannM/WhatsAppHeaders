...
@interface WAStellaSyncContactsNotifier : NSObject <WAStellaIntentHandling>
{
...
- (void)handleDidUpdateContactsStorageNotification:(id)arg1;
- (void)handleSyncContactsNotification:(id)arg1;
- (id)initWithContext:(id)arg1 allowList:(id)arg2 encryption:(id)arg3;
- (void)performContactSyncOperation;
- (_Bool)process:(id)arg1 error:(out id *)arg2;
- (_Bool)regenerateContactsSyncToken;
